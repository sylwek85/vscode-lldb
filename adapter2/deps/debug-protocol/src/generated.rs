...
/// The client should leave the data intact.
 pub __restart : Option<serde_json::Value> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct AttachResponse { /// Contains request result if success is true and optional error details if success is false.
...
/// used to explain why a breakpoint could not be verified.
 ...
 # [ serde ( rename = "additionalModuleColumns" ) ] pub additional_module_columns : Option<Vec<ColumnDescriptor>> , /// Available filters or options for the setExceptionBreakpoints request.
 # [ serde ( rename = "exceptionBreakpointFilters" ) ] pub exception_breakpoint_filters : Option<Vec<ExceptionBreakpointsFilter>> , /// The debug adapter supports the 'terminateDebuggee' attribute on the 'disconnect' request.
 # [ serde ( rename = "supportTerminateDebuggee" ) ] pub support_terminate_debuggee : Option<bool> , /// Checksum algorithms supported by the debug adapter.
 # [ serde ( rename = "supportedChecksumAlgorithms" ) ] pub supported_checksum_algorithms : Option<Vec<ChecksumAlgorithm>> , /// The debug adapter supports the 'completions' request.
 ...
 # [ serde ( rename = "supportsConditionalBreakpoints" ) ] pub supports_conditional_breakpoints : Option<bool> , /// The debug adapter supports the 'configurationDone' request.
 # [ serde ( rename = "supportsConfigurationDoneRequest" ) ] pub supports_configuration_done_request : Option<bool> , /// The debug adapter supports the delayed loading of parts of the stack, which requires that 
/// both the 'startFrame' and 'levels' arguments and the 'totalFrames' result of the 
/// 'StackTrace' request are supported.
 # [ serde ( rename = "supportsDelayedStackTraceLoading" ) ] pub supports_delayed_stack_trace_loading : Option<bool> , /// The debug adapter supports a (side effect free) evaluate request for data hovers.
 # [ serde ( rename = "supportsEvaluateForHovers" ) ] pub supports_evaluate_for_hovers : Option<bool> , /// The debug adapter supports the 'exceptionInfo' request.
 # [ serde ( rename = "supportsExceptionInfoRequest" ) ] pub supports_exception_info_request : Option<bool> , /// The debug adapter supports 'exceptionOptions' on the setExceptionBreakpoints request.
 # [ serde ( rename = "supportsExceptionOptions" ) ] pub supports_exception_options : Option<bool> , /// The debug adapter supports function breakpoints.
 # [ serde ( rename = "supportsFunctionBreakpoints" ) ] pub supports_function_breakpoints : Option<bool> , /// The debug adapter supports the 'gotoTargets' request.
...
/// hits.
 # [ serde ( rename = "supportsHitConditionalBreakpoints" ) ] pub supports_hit_conditional_breakpoints : Option<bool> , /// The debug adapter supports the 'loadedSources' request.
 # [ serde ( rename = "supportsLoadedSourcesRequest" ) ] pub supports_loaded_sources_request : Option<bool> , /// The debug adapter supports logpoints by interpreting the 'logMessage' attribute of the 
/// SourceBreakpoint.
 # [ serde ( rename = "supportsLogPoints" ) ] pub supports_log_points : Option<bool> , /// The debug adapter supports the 'modules' request.
 ...
 # [ serde ( rename = "supportsRestartFrame" ) ] pub supports_restart_frame : Option<bool> , /// The debug adapter supports the 'restart' request. In this case a client should not 
/// implement 'restart' by terminating and relaunching the adapter but by calling the 
/// RestartRequest.
 # [ serde ( rename = "supportsRestartRequest" ) ] pub supports_restart_request : Option<bool> , /// The debug adapter supports the 'setExpression' request.
 # [ serde ( rename = "supportsSetExpression" ) ] pub supports_set_expression : Option<bool> , /// The debug adapter supports setting a variable to a value.
 # [ serde ( rename = "supportsSetVariable" ) ] pub supports_set_variable : Option<bool> , /// The debug adapter supports stepping back via the 'stepBack' and 'reverseContinue' requests.
 # [ serde ( rename = "supportsStepBack" ) ] pub supports_step_back : Option<bool> , /// The debug adapter supports the 'stepInTargets' request.
 # [ serde ( rename = "supportsStepInTargetsRequest" ) ] pub supports_step_in_targets_request : Option<bool> , /// The debug adapter supports the 'terminateThreads' request.
 # [ serde ( rename = "supportsTerminateThreadsRequest" ) ] pub supports_terminate_threads_request : Option<bool> , /// The debug adapter supports a 'format' attribute on the stackTraceRequest, variablesRequest, 
/// and evaluateRequest.
 # [ serde ( rename = "supportsValueFormattingOptions" ) ] pub supports_value_formatting_options : Option<bool> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct CapabilitiesEventBody { /// The set of updated capabilities.
...
/// If missing the value 0 is assumed which results in the completion text being inserted.
 pub length : Option<i64> , /// This value determines the location (in the CompletionsRequest's 'text' attribute) where the 
...
/// true for the 'supportTerminateDebuggee' capability.
 # [ serde ( rename = "terminateDebuggee" ) ] pub terminate_debuggee : Option<bool> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct DisconnectRequest { /// Object containing arguments for the command.
 ...
 pub format : Option<ValueFormat> , /// Evaluate the expression in the scope of this stack frame. If not specified, the expression 
...
/// The client can use this optional information to present the variables in a paged UI and 
/// fetch them in chunks.
 # [ serde ( rename = "namedVariables" ) ] pub named_variables : Option<f64> , /// Properties of a evaluate result that can be used to determine how to render the result in 
/// the UI.
 # [ serde ( rename = "presentationHint" ) ] pub presentation_hint : Option<VariablePresentationHint> , /// The result of the evaluate request.
...
/// object.
 # [ serde ( rename = "evaluateName" ) ] pub evaluate_name : Option<String> , /// Fully-qualified type name of the exception object.
 # [ serde ( rename = "fullTypeName" ) ] pub full_type_name : Option<String> , /// Details of the exception contained by this exception, if any.
 # [ serde ( rename = "innerException" ) ] pub inner_exception : Option<Vec<ExceptionDetails>> , /// Message contained in the exception.
 pub message : Option<String> , /// Stack trace at the time the exception was thrown.
 # [ serde ( rename = "stackTrace" ) ] pub stack_trace : Option<String> , /// Short type name of the exception object.
 # [ serde ( rename = "typeName" ) ] pub type_name : Option<String> } /// Arguments for 'exceptionInfo' request.
 ...
 pub description : Option<String> , /// Detailed information about the exception.
 pub details : Option<ExceptionDetails> , /// ID of the exception that was thrown.
...
/// used to group exceptions in the UI.
 pub path : Option<Vec<ExceptionPathSegment>> } /// An ExceptionPathSegment represents a segment in a path that is used to match leafs or nodes in 
...
/// except the names provided.
 pub negate : Option<bool> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct ExitedEventBody { /// The exit code returned from the debuggee.
...
/// The possible goto targets can be determined via the 'gotoTargets' request.
 ...
 # [ serde ( rename = "clientID" ) ] pub client_id : Option<String> , /// The human readable name of the (frontend) client using this adapter.
 # [ serde ( rename = "clientName" ) ] pub client_name : Option<String> , /// If true all column numbers are 1-based (default).
 # [ serde ( rename = "columnsStartAt1" ) ] pub columns_start_at_1 : Option<bool> , /// If true all line numbers are 1-based (default).
 # [ serde ( rename = "linesStartAt1" ) ] pub lines_start_at_1 : Option<bool> , /// The ISO-639 locale of the (frontend) client using this adapter, e.g. en-US or de-CH.
 pub locale : Option<String> , /// Determines in what format paths are specified. The default is 'path', which is the native 
/// format.
...
/// The data is sent as the 'restart' attribute of the 'terminated' event.
/// The client should leave the data intact.
 pub __restart : Option<serde_json::Value> , /// If noDebug is true the launch request should launch the program without enabling debugging.
...
/// The 'loadedSources' request has no standardized arguments.
 ...
 pub arguments : Option<LoadedSourcesArguments> , /// The command to execute.
 pub command : String , /// Sequence number.
 pub seq : i64 , /// Message type.
...
/// For now it only specifies the columns to be shown in the modules view.
 ...
 pub category : Option<String> , /// An optional source location column where the output was produced.
 pub column : Option<i64> , /// Optional data to report. For the 'telemetry' category the data will be sent to telemetry, 
/// for the other categories the data is shown in JSON format.
 pub data : Option<serde_json::Value> , /// An optional source location line where the output was produced.
 pub line : Option<i64> , /// The output to report.
 pub output : String , /// An optional source location where the output was produced.
 pub source : Option<Source> , /// If an attribute 'variablesReference' exists and its value is > 0, the output contains 
/// objects which can be retrieved by passing variablesReference to the VariablesRequest.
 # [ serde ( rename = "variablesReference" ) ] pub variables_reference : Option<f64> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct OutputEvent { /// Event-specific information.
 ...
 # [ serde ( rename = "isLocalProcess" ) ] pub is_local_process : Option<bool> , /// The logical name of the process. This is usually the full path to process's executable 
/// file. Example: /home/example/myproj/program.js.
 pub name : String , /// Describes how the debug engine started debugging this process.
 # [ serde ( rename = "startMethod" ) ] pub start_method : Option<String> , /// The system process id of the debugged process. This property will be missing for non-system 
/// processes.
 # [ serde ( rename = "systemProcessId" ) ] pub system_process_id : Option<i64> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct ProcessEvent { /// Event-specific information.
...
/// The restart request has no standardized attributes.
 ...
 pub arguments : Option<RestartArguments> , /// The command to execute.
 pub command : String , /// Sequence number.
 pub seq : i64 , /// Message type.
 ...
 pub env : Option<::std::collections::BTreeMap<String, Option<String>>> , /// What kind of terminal to launch.
...
/// of the 'breakpoints' (or the deprecated 'lines') in the SetBreakpointsArguments.
 ...
 # [ serde ( rename = "exceptionOptions" ) ] pub exception_options : Option<Vec<ExceptionOptions>> , /// IDs of checked exception options. The set of IDs is returned via the 
/// 'exceptionBreakpointFilters' capability.
 ...
 pub format : Option<ValueFormat> , /// Evaluate the expressions in the scope of this stack frame. If not specified, the 
/// expressions are evaluated in the global scope.
 # [ serde ( rename = "frameId" ) ] pub frame_id : Option<i64> , /// The value expression to assign to the l-value expression.
...
/// The client can use this optional information to present the variables in a paged UI and 
/// fetch them in chunks.
 # [ serde ( rename = "namedVariables" ) ] pub named_variables : Option<f64> , /// Properties of a value that can be used to determine how to render the result in the UI.
 # [ serde ( rename = "presentationHint" ) ] pub presentation_hint : Option<VariablePresentationHint> , /// The optional type of the value.
 # [ serde ( rename = "type" ) ] pub type_ : Option<String> , /// The new value of the expression.
...
/// passing variablesReference to the VariablesRequest.
 # [ serde ( rename = "variablesReference" ) ] pub variables_reference : Option<f64> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct SetExpressionResponse { /// Contains request result if success is true and optional error details if success is false.
...
/// 'breakpoints' array.
 ...
 pub format : Option<ValueFormat> , /// The name of the variable.
...
/// from source map', etc.
 pub origin : Option<String> , /// The path of the source to be shown in the UI. It is only used to locate and load the 
/// content of the source if no sourceReference is specified (or its value is 0).
 pub path : Option<String> , /// An optional hint for how to present the source in the UI. A value of 'deemphasize' can be 
/// used to indicate that the source is not available or that it is skipped on stepping.
 # [ serde ( rename = "presentationHint" ) ] pub presentation_hint : Option<String> , /// If sourceReference > 0 the contents of the source must be retrieved through the 
...
/// so it must not be used to persist a source.
 # [ serde ( rename = "sourceReference" ) ] pub source_reference : Option<f64> , /// An optional list of sources that are related to this source. These may be the source that 
/// generated this source.
 pub sources : Option<Vec<Source>> } /// Arguments for 'source' request.
...
/// specified.
 pub source : Option<Source> , /// The reference to the source. This is the same as source.sourceReference. This is provided 
/// for backward compatibility since old backends do not understand the 'source' attribute.
 ...
 pub condition : Option<String> , /// An optional expression that controls how many hits of the breakpoint are ignored. The 
/// backend is expected to interpret the expression as needed.
 # [ serde ( rename = "hitCondition" ) ] pub hit_condition : Option<String> , /// The source line of the breakpoint or logpoint.
...
/// message instead. Expressions within {} are interpolated.
 # [ serde ( rename = "logMessage" ) ] pub log_message : Option<String> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct SourceRequest { /// Object containing arguments for the command.
...
/// A value of 'subtle' can be used to change the appearance of a frame in a 'subtle' way.
 # [ serde ( rename = "presentationHint" ) ] pub presentation_hint : Option<String> , /// The optional source of the frame.
 pub source : Option<Source> } # [ derive ( Clone , PartialEq , Debug , Default , Deserialize , Serialize ) ] pub struct StackFrameFormat { /// Display the value in hex.
 pub hex : Option<bool> , /// Includes all stack frames, including those the debug adapter might otherwise hide.
 # [ serde ( rename = "includeAll" ) ] pub include_all : Option<bool> , /// Displays the line number of the stack frame.
 pub line : Option<bool> , /// Displays the module of the stack frame.
 pub module : Option<bool> , /// Displays the names of parameters for the stack frame.
 # [ serde ( rename = "parameterNames" ) ] pub parameter_names : Option<bool> , /// Displays the types of parameters for the stack frame.
 # [ serde ( rename = "parameterTypes" ) ] pub parameter_types : Option<bool> , /// Displays the values of parameters for the stack frame.
 # [ serde ( rename = "parameterValues" ) ] pub parameter_values : Option<bool> , /// Displays parameters for the stack frame.
 pub parameters : Option<bool> } /// Arguments for 'stackTrace' request.
 ...
 pub format : Option<StackFrameFormat> , /// The maximum number of frames to return. If levels is not specified or 0, all frames are 
/// returned.
...
/// This means that there is no location information available.
 ...
 # [ serde ( rename = "targetId" ) ] pub target_id : Option<i64> , /// Execute 'stepIn' for this thread.
...
/// expanded.
 # [ serde ( rename = "allThreadsStopped" ) ] pub all_threads_stopped : Option<bool> , /// The full reason for the event, e.g. 'Paused on exception'. This string is shown in the UI 
/// as is.
 pub description : Option<String> , /// A value of true hints to the frontend that this event should not change the focus.
 # [ serde ( rename = "preserveFocusHint" ) ] pub preserve_focus_hint : Option<bool> , /// The reason for the event.
...
/// This string is shown in the UI.
 ...
 # [ serde ( rename = "threadIds" ) ] pub thread_ids : Option<Vec<i64>> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct TerminateThreadsRequest { /// Object containing arguments for the command.
...
/// '__restart' to the 'launch' and 'attach' requests.
 pub restart : Option<serde_json::Value> } # [ derive ( Clone , PartialEq , Debug , Deserialize , Serialize ) ] pub struct TerminatedEvent { /// Event-specific information.
 ...
 pub hex : Option<bool> } /// A Variable is a name/value pair.
...
/// fetch them in chunks.
 # [ serde ( rename = "indexedVariables" ) ] pub indexed_variables : Option<i64> , /// The variable's name.
 pub name : String , /// The number of named child variables.
/// The client can use this optional information to present the children in a paged UI and 
/// fetch them in chunks.
 # [ serde ( rename = "namedVariables" ) ] pub named_variables : Option<i64> , /// Properties of a variable that can be used to determine how to render the variable in the 
/// UI.
 # [ serde ( rename = "presentationHint" ) ] pub presentation_hint : Option<VariablePresentationHint> , /// The type of the variable's value. Typically shown in the UI when hovering over the value.
 # [ serde ( rename = "type" ) ] pub type_ : Option<String> , /// The variable's value. This can be a multi-line text, e.g. for a function the body of a 
/// function.
...
/// try to use the listed values.
 pub attributes : Option<Vec<String>> , /// The kind of variable. Before introducing additional values, try to use the listed values.
 pub kind : Option<String> , /// Visibility of variable. Before introducing additional values, try to use the listed values.
 pub visibility : Option<String> } /// Arguments for 'variables' request.
...
/// types are fetched.
 pub filter : Option<String> , /// Specifies details on how to format the Variable values.
 pub format : Option<ValueFormat> , /// The index of the first variable to return; if omitted children start at 0.
